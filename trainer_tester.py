...
class TrainerTester:
	...
	def train(self):
		...
		if (self.model.model_name == 'ED_SimplE'):
		    self.model.decompress(is_training=True)
	...
	def test_model_on(self, itr, valid_or_test="test"):
		...
		self.model.setup_weights()
		# self.model.decompress(is_training=False)
		if (self.model.model_name == 'ED_SimplE'):
		    self.model.decompress(is_training=False)
		...
		print("raw_mrr:",raw_mrr, "raw_hit1:",raw_hit1,"raw_hit3:", raw_hit3,"raw_hit10:", raw_hit10,"fil_mrr:", fil_mrr,"fil_hit1:", fil_hit1,"fil_hit3:", fil_hit3, "fil_hit10:",fil_hit10)
		return fil_mrr
